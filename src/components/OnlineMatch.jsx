            ...
            {CHARACTERS.map(c => {
              ...
              return (
                <button key={c.id}
                  ...
                  className={`p-2 rounded-xl border-2 relative flex flex-col items-center ${locked ? 'opacity-50 border-slate-700 bg-slate-800/50 cursor-not-allowed' : myPick === c.id ? 'border-amber-400 bg-amber-900/30' : 'border-slate-600 bg-slate-800 hover:border-slate-400'}`}>
